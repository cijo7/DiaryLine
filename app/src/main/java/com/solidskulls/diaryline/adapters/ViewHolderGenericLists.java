...
import com.solidskulls.diaryline.DataParser;
    ...
    public void setText(String list) {
        ...
        for (int i = 0; i < size; i++) {
            if(i>=3){
                ...
                stringBuilder.setSpan(new ForegroundColorSpan(Color.BLUE), len, stringBuilder.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
